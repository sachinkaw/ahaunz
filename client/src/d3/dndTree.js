export { appendTreeToNode }

// Global exports
global.rename_node = rename_node
global.create_node = create_node
global.create_sibling_node = create_sibling_node
global.create_parent_node = create_parent_node

var { $, d3, toastr, _ } = global

function appendTreeToNode ({ baseNodeSelector, treeData, onTreeUpdate }) {
  ...
  function delete_node (node) {
    ...
    saveTree(global.root)
    global.onTreeUpdateGlobal && global.onTreeUpdateGlobal(global.root)
  }
...
function saveTree (root) {
  global.onTreeUpdateGlobal && global.onTreeUpdateGlobal(root)
}
